...
The value comes from JPL's Keplerian elements for the Earth-Moon barycentre ([Approximate Positions of the Planets](https://ssd.jpl.nasa.gov/planets/approx_pos.html), Table 1, valid 1800–2050):
...
Computed from the JPL Keplerian elements ([Table 1, 1800–2050](https://ssd.jpl.nasa.gov/planets/approx_pos.html)) at T = 0, where the tabulated elements are the values themselves. Heliocentric, mean ecliptic and equinox of J2000. Azimuth is measured from direction 1 per section 11.
